package com.sandbox.higherOrderFunctions.parameterInference
...
//    val fun1 = 3 * _
    ...
    println(fun2.getClass.getName)  // com.sandbox.higherOrderFunctions.parameterInference.parameterInference$$anonfun$5
